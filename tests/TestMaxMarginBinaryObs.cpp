...
BOOST_AUTO_TEST_CASE(testMaxMarginBinaryObs)
{
  ...
  BOOST_CHECK_CLOSE(-0.0125, gradFv.getValueAtLocation(0).value(), 1e-6);
  BOOST_CHECK_CLOSE(-0.0166666666, gradFv.getValueAtLocation(1).value(), 1e-6);
  BOOST_CHECK_CLOSE(-0.0011904761, gradFv.getValueAtLocation(280).value(),1e-4);
  BOOST_CHECK_CLOSE(0.0125, gradFv.getValueAtLocation(362).value(), 1e-4);
