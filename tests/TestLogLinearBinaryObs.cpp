...
BOOST_AUTO_TEST_CASE(testLogLinearBinaryObs)
{
  ...
  BOOST_CHECK_CLOSE(-0.00478707453, gradFv.getValueAtLocation(0).value(), 1e-6);
  BOOST_CHECK_CLOSE(-0.00695716322, gradFv.getValueAtLocation(1).value(), 1e-6);
  BOOST_CHECK_CLOSE(5.85168e-06, gradFv.getValueAtLocation(280).value(), 1e-4);
  BOOST_CHECK_CLOSE(0.00668318, gradFv.getValueAtLocation(362).value(), 1e-4);
