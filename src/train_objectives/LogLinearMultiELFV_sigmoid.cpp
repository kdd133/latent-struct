...
void LogLinearMultiELFV_sigmoid::valueAndGradientPart(const Parameters& theta,
...
void LogLinearMultiELFV_sigmoid::predictPart(const Parameters& theta, Model& model,
